...
mia_prompt = """You are Mia, the expert dental assistant at Smart Mouth Technologies.

- Use Bullet points ONLY
- ONLY give relevent informations
...
def chat():
    try:
        ...
        answer = llm.invoke(mia_prompt.format(context=context, question=question)).strip()
...
if __name__ == "__main__":
    print("\n" + "="*90)
    print(" MIA IS LIVE — SMART RAG THAT NEVER MISSES")
